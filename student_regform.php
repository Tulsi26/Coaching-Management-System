...
<h3>Empower Your Learning Journey: Join Our Classes Today</h3></center>
    ...
    <form action="stinsert.php" method="get">
        <table>
            <tr>
                <th>Field</th>
                <th>Details</th>
            ...
            <tr>
                ...
                <td><input type="varchar" id="semester" name="semester" required></td>
            </tr>
            <tr>
                <td><label for="enrollment">Enrollment ID:</label></td>
                <td><input type="text" id="e_id" name="e_id" required></td>
            </tr>
            <tr>
